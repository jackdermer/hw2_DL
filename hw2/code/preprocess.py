...
def get_data(file_path, first_class, second_class):
	...
	label_1 = (labels == first_class)
	label_2 = (labels == second_class)
	inp_1 = inputs[np.nonzero(label_1)[0]]
	inp_2 = inputs[np.nonzero(label_2)[0]]

	new_inputs = np.float32(np.append(inp_1, inp_2) / 255)
